...
import MyBooking from '../section-components/mybooking'
			        ...
			        <div className="row">
			          <div className="col-lg-4">
			            <ul className="nav nav-tabs tp-tabs style-two">
			              ...
			              <li className="nav-item">
			                <a className="nav-link" data-toggle="tab" href="#tabs_4"><i className="fa fa-recycle" />My booking</a>
			              </li>
			              <li className="nav-item">
			            ...
			            <div className="tab-content user-tab-content">
			              ...
			              <div className="tab-pane fade" id="tabs_4">
			                <div className="user-recent-view">
			                  <h3 className="user-details-title">My booking</h3>
			                  <div className="row">
