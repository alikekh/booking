			    ...
			    <div className="row justify-content-center">
			      ...
			      <div className="col-xl-8 col-lg-9 text-center">
			        <div className="video-popup-wrap style-two">
			          <div className="thumb">
			            <img src="https://picsum.photos/id/1050/1082/633" alt="video" />
			          </div>
			          <div className="video-popup-btn">
			            <a href="https://www.youtube.com/watch?v=0wCC3aLXdOw" className="video-play-btn mfp-iframe"><i className="fa fa-play" /></a>
			          </div>
			        </div>
			      </div>
			    </div>
